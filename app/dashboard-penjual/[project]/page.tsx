...
import { ChevronLeft, MapPin, ShieldCheck, CircleCheck } from "lucide-react";
      ...
      <main className="pt-[110px] pb-16 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="">
          <div className="space-y-6">
            ...
            <div className="w-[1215px] h-[222px] rounded-[8px] border-[1.5px] border-[#D9D9D9] flex flex-col px-10 py-2 items-center">
              <div className="w-full h-10 border-b flex items-center">
                <ShieldCheck size={28} className="ml-5"/>
                <p className="font-bold text-[14px] ml-10 w-full">
            ...
            <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-500">Ringkasan status inventaris kredit karbon dengan audit dan buffer risiko.</p>
                </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
                {[
                  { label: "Retired", value: "5,000", tone: "bg-slate-900 text-white" },
                  { label: "Sold (Active)", value: "2,500", tone: "bg-emerald-500 text-white" },
                  { label: "Reserved", value: "1,000", tone: "bg-amber-400 text-slate-950" },
                  { label: "Buffer (Risk)", value: "1,000", tone: "bg-rose-400 text-slate-950" },
                  { label: "Available", value: "10,500", tone: "bg-sky-500 text-white" },
                ].map((item) => (
                  <div key={item.label} className="rounded-[24px] border border-slate-200 bg-slate-50 p-4">
                    <p className="text-xs uppercase tracking-[0.2em] text-slate-500">{item.label}</p>
                    <p className={`mt-4 inline-flex rounded-full px-3 py-2 text-sm font-semibold ${item.tone}`}>{item.value}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 rounded-[24px] border border-slate-200 bg-slate-50 p-5">
                ...
                <div className="flex h-4 overflow-hidden rounded-full bg-slate-200">
                  ...
                  <div className="h-full w-[12.5%] bg-emerald-500" />
                  <div className="h-full w-[5%] bg-amber-400" />
                  <div className="h-full w-[5%] bg-rose-400" />
                  <div className="h-full w-[52.5%] bg-sky-500" />
                </div>
              </div>
            </section>
            ...
            <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-5 flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-500">Catatan transaksi penjualan investor yang diaudit.</p>
                </div>
              </div>

              <div className="overflow-hidden rounded-[24px] border border-slate-200 bg-slate-50">
                <div className="grid grid-cols-[220px_140px_120px_120px_180px] gap-4 border-b border-slate-200 px-5 py-4 text-xs uppercase tracking-[0.22em] text-slate-500">
                  <span>Buyer</span>
                  <span>Date</span>
                  <span>Volume</span>
                  <span>Total</span>
                ...
                <div className="grid grid-cols-[220px_140px_120px_120px_180px] gap-4 px-5 py-4 text-sm text-slate-700">
