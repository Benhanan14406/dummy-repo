...
import { metodologiType, SetUpParams } from "@/interfaces/interface";

export default function SetUp({ stateSetters }: { stateSetters: SetUpParams })
{
    const { setNamaProyek, setLuasArea, setDeforestasi, setMetodologi } = stateSetters;
        ...
        <div className="flex flex-col w-full gap-7 items-center justify-center">
            ...
            <Card className="w-full py-7">
                <div className="flex flex-col items-center w-280.5 mx-auto gap-7">
                        ...
                        <div className="flex flex-col gap-5 w-135">
                            ...
                            <div className="flex flex-col gap-1 w-full">
                                ...
                                <Combobox items={methodologies}>
                                    <ComboboxInput placeholder="Select a Methodology" className="w-full h-11"/>
                                    <ComboboxContent>
                                        {
                    ...
                    <Button className="flex items-center justify-center w-full h-14.5 text-sh-l font-bold text-white hover:cursor-pointer hover:bg-blue-700">
